# Generated by Django 5.2.6 on 2025-11-09 07:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('man', 'Man'), ('woman', 'Woman'), ('non_binary', 'Non-binary')], max_length=20, null=True)),
                ...
                ('hobbies', models.ManyToManyField(blank=True, related_name='users', to='account.hobbies')),
            ],
            options={
                'verbose_name': 'User',
